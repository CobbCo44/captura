...
export const PLANS = {
  storefront: {
    starter: { lookup_key: 'storefront_starter', name: 'MeetCaptura Storefront Starter', amount: 9900 },
    growth: { lookup_key: 'storefront_growth', name: 'MeetCaptura Storefront Growth', amount: 29900 },
