          ...
          <div style={{ padding: '24px 0', borderBottom: `1px solid ${tokenVars['--scan-border']}` }}>
            {!showWarranty && !warrantyRegistered && (
              <div style={{
                ...
                <button style={{ padding: '14px 32px', ...btnStyle, border: 'none', borderRadius: 'var(--radius)', fontWeight: 700, cursor: 'pointer' }}
              ...
              <form onSubmit={handleWarrantySubmit} style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
                ...
                {product.warranty_terms && (
                  <div style={{
                    ...
                    border: `1px solid ${tokenVars['--scan-border']}`, fontSize: '0.8rem',
                ...
                <button type="submit" style={{ width: '100%', padding: 14, ...btnStyle, border: 'none', borderRadius: 'var(--radius)', fontWeight: 700, cursor: 'pointer' }}>
                  Register Warranty
                </button>
              </form>
            )}
