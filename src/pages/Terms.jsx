  ...
  return (
    <div style={{ minHeight: '100vh', maxWidth: 700, margin: '0 auto', padding: '40px 24px' }}>
      ...
      <div style={{ color: 'var(--text-muted)', lineHeight: 1.8, fontSize: '0.95rem' }}>
        ...
        <p style={{ marginBottom: 16 }}>By accessing or using MeetCaptura, you agree to be bound by these Terms of Service. If you do not agree, do not use the platform.</p>

        <h2 style={{ color: '#FAFAFA', fontSize: '1.2rem', fontWeight: 600, marginTop: 32, marginBottom: 12 }}>2. Description of Service</h2>
        <p style={{ marginBottom: 16 }}>MeetCaptura provides QR code-based consumer engagement tools for brands, including QR code generation, scan analytics, VIP member collection, and promotional campaign management.</p>
        ...
        <p style={{ marginBottom: 16 }}>MeetCaptura collects consumer data on behalf of brands, including names, phone numbers, email addresses, and geographic location data (with consumer consent). Brands are responsible for compliance with applicable data protection laws in their jurisdiction.</p>

        <h2 style={{ color: '#FAFAFA', fontSize: '1.2rem', fontWeight: 600, marginTop: 32, marginBottom: 12 }}>5. Acceptable Use</h2>
        <p style={{ marginBottom: 16 }}>You may not use MeetCaptura for any unlawful purpose, to distribute spam, or to collect data without proper consumer consent.</p>

        <h2 style={{ color: '#FAFAFA', fontSize: '1.2rem', fontWeight: 600, marginTop: 32, marginBottom: 12 }}>6. Limitation of Liability</h2>
        <p style={{ marginBottom: 16 }}>MeetCaptura is provided "as is" without warranties of any kind. We are not liable for any damages arising from your use of the platform.</p>
